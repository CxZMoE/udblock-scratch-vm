...
class UDSensorSimpleRemote {
    ...
    getInfo() {
        return {
            id: "simpleRemoteSensor",
            name: "简易遥控器",
            blockIconURI: blockIconURI,
            blocks: [
                {
                    opcode: 'simpleRemoteInit',
                    blockType: BlockType.COMMAND,
                    text: '初始化简易遥控传感器于热点: [SSID]密码: [PSK]',
                    arguments: {
                        SSID: {
                ...
                {
                    opcode: 'simpleRemoteDeinit',
                    blockType: BlockType.COMMAND,
                    text: '关闭简易遥控传感器'
                },
                {
                    opcode: 'simpleRemoteUpPressed',
                    blockType: BlockType.BOOLEAN,
                    text: '上键被按下'
                },
                {
                    opcode: 'simpleRemoteDownPressed',
                    blockType: BlockType.BOOLEAN,
                    text: '下键被按下'
                },
                {
                    opcode: 'simpleRemoteLeftPressed',
                    blockType: BlockType.BOOLEAN,
                    text: '左键被按下'
                },
                {
                    opcode: 'simpleRemoteRightPressed',
                    blockType: BlockType.BOOLEAN,
                    text: '右键被按下'
                },
                {
                    opcode: 'simpleRemoteLSPressed',
                    blockType: BlockType.BOOLEAN,
                    text: '左方块被按下'
                },
                {
...
module.exports = UDSensorSimpleRemote;