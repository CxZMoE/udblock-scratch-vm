    ...
    getInfo() {
        return {
            ...
            blocks: [
                ...
                {
                    opcode: 'readColorSensor',
                    blockType: BlockType.REPORTER,
                    text: '读取颜色识别传感器的[COLOR]',
                    arguments: {
                        COLOR: {
                            type: ArgumentType.STRING,
                            defaultValue: -1,
                            menu: "colorDetectMenu"
                        }
                    }
                },
                {
            ...
            menus: {
                RJMenu: {
                    ...
                    items: [
                        ...
                        {text:"RJ6", value:EXTB_LIST.extb_io.RJ11[6].value.join(",")},
                        {text:"RJ6", value:EXTB_LIST.extb_io.RJ11[7].value.join(",")},
                    ]
                },
                RJDigiMenu: {
                    acceptReporters: true,
