        ...
        return {
            ...
            menus: {
                ...
                servoMenu: {
                    acceptReporters: true,
                    items: [
                        {text:"一", value:extb_mf.servo[0].value.join(",")},
                        {text:"二", value:extb_mf.servo[1].value.join(",")},
                        {text:"三", value:extb_mf.servo[2].value.join(",")},
                        {text:"四", value:extb_mf.servo[3].value.join(",")},
                    ]
                },
                motorMenu: {
                    acceptReporters: true,
                    items: [
                        {text:"一", value:extb_mf.motor[0].value.join(",")},
                        {text:"二", value:extb_mf.motor[1].value.join(",")},
                    ]
                },
